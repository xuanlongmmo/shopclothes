		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form method="POST" action="{{ route('admin.postlogin') }}" class="login100-form validate-form">
                    @csrf
                    <div class="wrap-input100 validate-input m-b-26" data-validate="Username không được để trống">
						<span class="label-input100">Username</span>
						<input class="input100" type="text" name="username" placeholder="Enter username">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-18" data-validate = "Password không được để trống">
